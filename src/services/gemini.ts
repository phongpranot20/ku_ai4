...
export const AVAILABLE_MODELS = [
  { id: "gemini-3-flash-preview", name: "Gemini 3 Flash", description: "เร็วที่สุด" },
  { id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro", description: "ฉลาดที่สุด" },
  { id: "gemini-3.1-flash-lite-preview", name: "Gemini 3.1 Flash Lite", description: "ประหยัดโควต้า" }
];
